  ...
  return (
    <div>
      ...
      {!session?.user?.isVerified && (
        <div className="mb-6 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-400 dark:border-yellow-700/50 rounded-lg p-3 sm:p-4 shadow-sm">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            <div className="flex items-center gap-2 flex-1">
              <AlertCircle className="h-5 w-5 text-yellow-600 dark:text-yellow-500 flex-shrink-0" />
              <div>
                <h3 className="font-semibold text-sm text-yellow-800 dark:text-yellow-500">Account Pending Verification</h3>
                <p className="text-xs text-yellow-700 dark:text-yellow-200 mt-0.5">
                  Awaiting admin approval. Refresh the page to check status.
                </p>
              </div>
            </div>
            <a
              ...
              className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 bg-green-600 text-white rounded-md text-xs font-semibold hover:bg-green-700 transition-colors sm:self-center"
            >
